...
int newCombat(NEXT player1, NEXT player2);
...
int main() {
	...
	player1Mecha.setMechaX(1);
	player1Mecha.setMechaY(1);
	std::cout << "\nPlayer 2 please select your mecha" << std::endl;
	player2Mecha = mechSelection(listOfMechs, actualMechas);
	player2Mecha.setMechaX(4);
	player2Mecha.setMechaY(4);
	//menuSelection=commandMenu();
...
int combatPhase1(NEXT player1, NEXT player2)
{
	...
	while (1)
	{
		if (playerUp == 1)
		{
			...
			{
				player1 = mapMvt(1, player1, player2);
			}
			else if (menuSelection == 3)
			{
				...
				std::cout << "Player2 HP is now " << player2.getHP() << std::endl;
				std::cout << "Player2 power is now " << player2.getPower() << std::endl;
				std::cout << "Player1 speed is " << player1.getSpeed();
			}
		...
		else if (playerUp == 2)
		{
			...
			{
				player2=mapMvt(2,player1,player2);
			}
			else if (menuSelection == 3)
			{
				std::cout << "Player1 HP is now " << player1.getHP() << std::endl;
				...
				std::cout << "Player2 HP is now " << player2.getHP() << std::endl;
				std::cout << "Player2 power is now " << player2.getPower() << std::endl;
				std::cout << "Player2 speed is " << player2.getSpeed();
			}
			else if (menuSelection == 4)
			{
				printMap2(player1, player2);
...
int commandMenu()
{
	std::cout << "\n";
	std::cout << "--------------------------------------------\n";
	std::cout << "Press 1 for combat		Press 2 to move\n";
	std::cout << "Press 3 for stats 		Press 4 for map\n";
